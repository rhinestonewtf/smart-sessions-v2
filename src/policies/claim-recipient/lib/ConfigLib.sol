...
library ConfigLib {
    ...
    struct InitData {
        ...
        // Pre-claim operations configuration
        ParamRules preClaimOpsConfig;
    ...
    /// @notice Returns if the bitmap has the preClaimOps condition set
    /// @return true if the preClaimOps condition is set, false otherwise
    function hasCheckPreClaimOps(PolicyConfig config) internal pure returns (bool) {
