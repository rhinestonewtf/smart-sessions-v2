...
//     ///      executions are included in the hash that is passed to this function and signed by
// the
//     ///      session key
...
//         // after enabling the session, the policies will be enforced on the userOp similarly to
// the
//         // SmartSession.USE
...
//         if (
//             !$enabledSessions.contains({ account: account, value:
...
//         // this is critical as it is the only way to ensure that the user is aware of the
// policies
//         // and signer
