...
/// @title BaseConfigLib.initializeOriginOps Unit Tests
/// @notice Unit tests for the initializeOriginOps function
contract BaseConfigLib_initializeOriginOps_Unit_Test is BaseConfigLib_Unit_Test {
    /*//////////////////////////////////////////////////////////////
                               LIBRARIES
    //////////////////////////////////////////////////////////////*/
    ...
    function initializeOriginOpsExternal(
        ConfigId _configId,
        address _account,
        ...
        returns (bytes memory)
    {
        ...
        bytes calldata _remaining = $.initializeOriginOps(_initData);
        return _remaining;
    }
    ...
    function test_initializeOriginOps_withZeroEntries() external {
        // Arrange - count = 0
        data = abi.encodePacked(uint8(0));

        // Act
        remaining = this.initializeOriginOpsExternal(configId, account, data);
    ...
    function test_initializeOriginOps_withRequiredTrue() external {
    ...
    function test_initializeOriginOps_withRequiredFalse() external {
    ...
    function test_initializeOriginOps_withMultipleEntries() external {
        // Arrange - count = 2
    ...
    function test_initializeOriginOps_withExtraData() external {
        // Arrange
    ...
    /// @notice Fuzz test for initializeOriginOps
    function testFuzz_initializeOriginOps(uint256 _chainId, bool _required) external {
        // Arrange
